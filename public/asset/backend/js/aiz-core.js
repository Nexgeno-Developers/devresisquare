        ...
        slickCarousel: function () {
            $(".aiz-carousel").not(".slick-initialized").each(function () {
                ...
                $this.slick({
                    ...
                    slidesToScroll: 1,
                    prevArrow:
                        '<button type="button" class="slick-prev" aria-label="Left Arrow"><i class="las la-angle-left"></i></button>',
                    nextArrow:
                        '<button type="button" class="slick-next" aria-label="Right Arrow"><i class="las la-angle-right"></i></button>',
                    responsive: [
                        {
                            breakpoint: 1500,
                            settings: {
