    ...
    <div class="steps_wrapper">
        ...
        <div class="form-group">
            ...
            <div class="rs_radio_btns">
                <span>
                    <input type="radio" name="parking" value="0" {{ old('parking') == '0' ? 'checked' : '' }}> No
                </span>
                <span>
                    <input type="radio" name="parking" value="1" {{ old('parking') == '1' ? 'checked' : '' }}> Yes
                </span>
                @error('parking')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
        ...
        <div class="form-group">
            ...
            <div class="rs_radio_btns">
                <span>
                    <input type="radio" name="balcony" value="0" {{ old('balcony') == '0' ? 'checked' : '' }}> No
                </span>
                <span>
                    <input type="radio" name="balcony" value="1" {{ old('balcony') == '1' ? 'checked' : '' }}> Yes
                </span>
                @error('balcony')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
        ...
        <div class="form-group">
            ...
            <div class="rs_radio_btns">
                <span>
                    <input type="radio" name="garden" value="0" {{ old('garden') == '0' ? 'checked' : '' }}> No
                </span>
                <span>
                    <input type="radio" name="garden" value="1" {{ old('garden') == '1' ? 'checked' : '' }}> Yes
                </span>
                @error('garden')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
        ...
        <div class="form-group">
            ...
            <div class="rs_radio_btns">
                <span>
                    <input type="radio" name="collecting_rent" value="0" {{ old('collecting_rent') == '0' ? 'checked' : '' }}> No
                </span>
                <span>
                    <input type="radio" name="collecting_rent" value="1" {{ old('collecting_rent') == '1' ? 'checked' : '' }}> Yes
                </span>
