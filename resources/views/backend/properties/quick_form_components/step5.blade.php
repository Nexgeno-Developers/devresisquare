...
<div class="container-fluid mt-4 quick_add_property">
    <div class="row">
        ...
        <div class="col-md-6 col-12 right_col">
            <form id="property-form-step-5" method="POST" action="{{ route('admin.properties.quick_store') }}">
                @csrf
                ...
                <div class="right_content_wrapper" data-step-name="Property Address" data-step-number="1">
                    <div class="form-group">
                        ...
                        <div class="price_input_wrapper">
                            ...
                            <input type="text" name="price" id="price" class="form-control" value="{{ isset($property) && $property->price ? $property->price : '' }}">
                        </div>
                        @error('price')
                ...
                <button type="submit" class="btn btn-primary margin-top-5 mt-5 w-100 last-step-submit" data-current-step="5">Submit</button>
            </form>
        </div>
    </div>
</div>