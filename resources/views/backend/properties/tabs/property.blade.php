    ...
    <div class="pvd_other_content border_bottom">
        <div class="row">
            <div class="col-lg-4 col-6">
                <div class="row">
                    <div class="col-lg-5 col-12 mb-2">Furniture</div>
                    <div class="col-lg-7 col-12 mb-2">{{$furniture}}</div>
                    <div class="col-lg-5 col-12 mb-2">Parking</div>
                    <div class="col-lg-7 col-12 mb-2">{{$parking}}</div>
                    <div class="col-lg-5 col-12 mb-2">Balcony</div>
                    <div class="col-lg-7 col-12 mb-2">{{$balcony}}</div>
                    <div class="col-lg-5 col-12 mb-2">Garden</div>
                    <div class="col-lg-7 col-12 mb-2">{{$garden}}</div>
                </div>
            </div>
            <div class="col-lg-4 col-6">
                <div class="row">
                    <div class="col-lg-6 col-12 mb-2">Collecting Rent</div>
                    <div class="col-lg-6 col-12 mb-2">{{$collectingRent}}</div>
                    <div class="col-lg-6 col-12 mb-2">Area Sqr. Feet</div>
                    <div class="col-lg-6 col-12 mb-2">{{$squareFeet}}</div>
                    <div class="col-lg-6 col-12 mb-2">Area Sqr. Meter</div>
                    <div class="col-lg-6 col-12 mb-2">{{$squareMeter}}</div>
