                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group"> 
                                ...
                                <textarea required name="job_scope" class="form-control">{{ old('job_scope', $repairIssue->workOrder->job_scope ?? '') }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group"> 
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="invoice_company">
                                        Company <small>(no invoice to be generated)</small>
                                      </label>                                      
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group"> 
                                ...
                                <select required name="status" class="form-control">
                                    <option value="Raised" {{ old('status', $repairIssue->workOrder->status ?? '') == 'Raised' ? 'selected' : '' }}>Raised</option>
                                    <option value="Outstanding" {{ old('status', $repairIssue->workOrder->status ?? '') == 'Outstanding' ? 'selected' : '' }}>Outstanding</option>
                                    <option value="Completed - Invoice Received" {{ old('status', $repairIssue->workOrder->status ?? '') == 'Completed - Invoice Received' ? 'selected' : '' }}>Completed - Invoice Received</option>
                                    <option value="Cancelled" {{ old('status', $repairIssue->workOrder->status ?? '') == 'Cancelled' ? 'selected' : '' }}>Cancelled</option>
                                </select>
                            </div>
                        </div>
